...
namespace ServidorApiRestaurante.Controllers
{
    public class BDDController
    {
        ...
        public static void CrearTablas()
        {
            ...
            ;INSERT IGNORE INTO articulos (id, precio, nombre, categoria) VALUES (1,5,'coca cola','bebidas'),(2,50,'Filete wagyu','Platos'),(3,10,'Fondue','postres'),(4,7,'Bravas','Entrantes'),(6,6,'string','string'),(15,0,'string','string'),(99,23,'Bistec','Platos');
            ";
